...
<html lang="en">
  <head>
    ...
    <style>
        ...
        #myCanvas{
          ...
          border-radius: 2px;
          border: 6px solid #eb1c72;
        }
        #buttonstyle{
          background-color: #ffd3f4;
          border: 4px solid #eb1c72;
          border-radius: 5px;
          color: black;
          padding: 15px 32px;
          text-align: center;
        ...
        #bg{
            background-color: rgb(223, 104, 140);
        }
        #shooky{
  ...
  <body id="bg">
    <div id="content">
      <canvas id="myCanvas" width="750" height="750" onclick="showCoords(event)"></canvas></div>
      <center>
      ...
      <button onclick="change_color(this)" id="shooky" style="background: rgb(241, 45, 45);"></button>
      ...
      <button onclick="change_color(this)" id="shooky" style="background: rgb(70, 21, 2);"></button>
    ...
    color:#0c0007;
    font-weight: bold;
    font-size: 20px;">Paint Application Program, Developed by Dharshini D.S</p>
  </body>
</html>
```
## OUTPUT:
